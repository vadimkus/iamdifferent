  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <a href="/videos" className="text-black font-light">
                Бесплатные видео
              </a>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-white py-12 md:py-16 lg:py-24 border-b border-gray-300">
          <div className="max-w-6xl mx-auto px-4 md:px-8 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-light text-black mb-3 md:mb-4">
              Бесплатные видео
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 font-light max-w-3xl mx-auto px-2">
                ...
                <div key={categoryIndex}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {category.videos.map((video, videoIndex) => (
                      <div
                        key={videoIndex}
                        className="group bg-white overflow-hidden transition-all duration-300 border border-gray-300 hover:border-black cursor-pointer"
                      >
                        <div className="relative aspect-video bg-gray-100">
                          ...
                          <div className="absolute inset-0 bg-black/20 group-hover:bg-black/30 transition-colors flex items-center justify-center">
                            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/90 flex items-center justify-center">
                              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-black ml-0.5 sm:ml-1" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="p-4 sm:p-5">
                          <h3 className="text-base sm:text-lg font-light text-black mb-2 group-hover:text-gray-600 transition-colors">
                            {video.title}
                          </h3>
        ...
        {/* CTA Section */}
        <section className="bg-black text-white py-12 md:py-16 lg:py-24 border-y border-gray-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-light mb-4 md:mb-6">
              Хотите больше практик?
            </h2>
            <p className="text-base sm:text-lg md:text-xl font-light mb-6 md:mb-8 leading-relaxed text-gray-300 px-2">
            ...
            <a
              href="/smirnova#contact"
              className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-white text-black hover:bg-gray-200 transition-colors font-light text-base sm:text-lg border border-white"
            >
              Связаться со мной
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-black text-gray-400 py-10 md:py-12 lg:py-16 border-t border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
