  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              <a href="/smirnova" className="text-black font-light">
                Главная
              </a>
              <a href="/smirnova#about" className="text-gray-600 hover:text-black font-light transition-colors">
                О нас
              </a>
              <a href="/faq" className="text-gray-600 hover:text-black font-light transition-colors">
                Частые вопросы
              </a>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative bg-white py-12 sm:py-16 md:py-20 lg:py-32 border-b border-gray-300">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-light text-black mb-4 sm:mb-5 md:mb-6 leading-tight">
              Йога — это искусство пробуждения.
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 font-light mb-3 sm:mb-4 leading-relaxed max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 font-light mb-6 sm:mb-7 md:mb-8 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto px-4 md:px-8 text-center">
            ...
            <form className="flex flex-col md:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 focus:outline-none focus:border-black font-light"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-black text-white hover:bg-gray-800 transition-colors font-light border border-black"
              >
                Подписаться
              </button>
            </form>
        ...
        <section className="bg-gray-100 py-12 md:py-16 border-y border-gray-300">
          <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-light text-black mb-4">
              В этом месяце... Тема нашего сообщества — <span className="text-black font-normal">РИТМ</span>
            </h2>
        ...
        {/* About Section */}
        <section id="about" className="bg-white py-16 md:py-24 border-b border-gray-300">
          <div className="max-w-4xl mx-auto px-4 md:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <a
                  href="#contact"
                  className="inline-block mt-6 px-6 py-3 bg-black text-white hover:bg-gray-800 transition-colors font-light border border-black"
                >
                  Узнать больше о Нине
                </a>
              </div>
              <div className="bg-gray-100 p-8 md:p-12 flex items-center justify-center min-h-[300px] border border-gray-300">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-black flex items-center justify-center">
        ...
        {/* Courses Section */}
        <section id="courses" className="bg-white py-16 md:py-24 border-b border-gray-300">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {['Основы йоги', 'Виньяса флоу', 'Йога для начинающих', 'Утренняя йога', 'Вечерняя релаксация', 'Йога для гибкости'].map((course, index) => (
                <div key={index} className="bg-white p-6 border border-gray-300 hover:border-black transition-colors">
                  <h3 className="text-xl font-light text-black mb-3">{course}</h3>
                  ...
                  <a href="#contact" className="text-black hover:text-gray-600 font-light text-sm">
                    Узнать больше →
                  </a>
                </div>
              ))}
        ...
        <section className="bg-black text-white py-16 md:py-24 border-y border-gray-300">
          <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-light mb-6">
              Найди то, что приносит радость
            </h2>
            <p className="text-lg md:text-xl font-light mb-8 leading-relaxed text-gray-300">
            ...
            <p className="text-lg md:text-xl font-light mb-10 leading-relaxed text-gray-300">
            ...
            <a
              href="#contact"
              className="inline-block px-8 py-4 bg-white text-black hover:bg-gray-200 transition-colors font-light text-lg border border-white"
            >
        ...
        {/* Contact Section */}
        <section id="contact" className="bg-white py-16 md:py-24 border-b border-gray-300">
          <div className="max-w-4xl mx-auto px-4 md:px-8">
            <h2 className="text-3xl md:text-4xl font-light text-black mb-12 text-center">
              Свяжитесь со мной
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <a
                ...
                className="group bg-white p-8 hover:border-black transition-all duration-300 border border-gray-300"
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-light text-black">Instagram</h3>
                </div>
                <p className="text-black font-light">@nina.smirnovaa</p>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-light text-black">Email</h3>
                </div>
                <p className="text-black font-light break-all">Healthy.smirnova@gmail.com</p>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-light text-black">Telegram</h3>
                </div>
                <p className="text-black font-light">@nina_smirnova</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#about" className="hover:text-white transition-colors font-light">О Нине</a></li>
                <li><a href="/faq" className="hover:text-white transition-colors font-light">Частые вопросы</a></li>
                <li><a href="#contact" className="hover:text-white transition-colors font-light">Контакты</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-light mb-4">Курсы</h3>
              <ul className="space-y-2 text-sm">
                <li><a href="#courses" className="hover:text-white transition-colors font-light">Все курсы</a></li>
                <li><a href="/videos" className="hover:text-white transition-colors font-light">Бесплатные видео</a></li>
                <li><a href="#courses" className="hover:text-white transition-colors font-light">Мастер-классы</a></li>
              </ul>
            </div>
            <div>
